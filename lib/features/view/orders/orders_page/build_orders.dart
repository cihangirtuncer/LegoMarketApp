...
/*
class OrdersDocumentData extends StatefulWidget {
  OrdersDocumentData(String? paths);

  @override
  _OrdersDocumentDataState createState() => _OrdersDocumentDataState();
}

final FirebaseAuth _auth = FirebaseAuth.instance;
bool? dataBool;

class _OrdersDocumentDataState extends State<OrdersDocumentData> {
  final _usersStream = FirebaseFirestore.instance
      .collection('users')
      .doc(_auth.currentUser!.uid.toString())
      .collection('orders')
